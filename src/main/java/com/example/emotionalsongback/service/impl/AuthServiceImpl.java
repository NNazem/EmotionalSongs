...
public class AuthServiceImpl implements AuthService {
    ...
    public JwtAuthResponse login(LoginDto loginDto) {
        ...
        Optional<Utente> userOptional = utenteRepository.findByUsernameOrEmail(loginDto.getUsernameOrEmail(), loginDto.getUsernameOrEmail());

        String role = null;
        if(userOptional.isPresent()){
            Utente loggedInUser = userOptional.get();
